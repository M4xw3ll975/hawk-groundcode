...
!function (global, setTimeout) {
    var req,
        ...
        isBrowser = !(
            "undefined" == typeof window || "undefined" == typeof navigator || !window.document
        ),
    ...
    if (void 0 === define) {
        ...
        req.load = function (t, i, r) {
            ...
            if (isBrowser) 
                ...
                !e.attachEvent || e.attachEvent.toString && e
                    .attachEvent
                    .toString()
        ...
        isBrowser && !cfg.skipDataMain && eachReverse(scripts(), function (e) {
            if (head || (head = e.parentNode), dataMain = e.getAttribute("data-main")) 
                ...
                req
                    .jsExtRegExp
                    .test(mainScript) && (mainScript = dataMain),
                cfg.deps = cfg.deps
                    ? cfg
                        .deps
                        .concat(mainScript)
        ...
        define = function (e, i, t) {
            ...
            !i && isFunction(t) && (i = [], t.length && (
                t.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp, function (e, t) {
                    i.push(t)
                }),
                i = (
                    1 === t.length
                ...
                u && each(a, function (e) {
                    !function n(o, a, s) {
                        ...
                        o.error
                            ...
                            : (a[e] = !0, each(o.depMaps, function (e, t) {
                                var i = e.id,
                                    r = getOwn(p, i);
            ...
            callPlugin: function () {
                ...
                M(e, "defined", bind(this, function (e) {
                    ...
                    return this.map.unnormalized
                        ? (
                            e.normalize && (n = e.normalize(n, function (e) {
                                return q(e, a, !0)
                            }) || ""),
                            ...
                            : (
                                (o = bind(this, function (e) {
                                    ...
                                    eachProp(p, function (e) {
                                        0 === e
                                            .map
                                            .id
                                            .indexOf(c + "_unnormalized") && P(e.map.id)
                                    }),
                                    O(e)
                                }),
                                o.fromText = bind(this, function (e, t) {
                                    ...
                                    try {
                                        ...
                                        return O(
                                            makeError("fromtexteval", "fromText eval for " + c + " failed: " + e, e, [c])
                                        )
                                    }
                                    n && (useInteractive = !0),
                                    this
                ...
                each(this.depMaps, bind(this, function (e, t) {
                    ...
                    if ("string" == typeof e) {
                        if (e = S(
                            ...
                            !1,
                            !this.skipMap
                        ), this.depMaps[t] = e, n = getOwn(c, e.id)) 
                        ...
                        this.errback
                            ...
                            : this.events.error && M(e, "error", bind(this, function (e) {
                                this.emit("error", e)
                            }))
                    }
                    i = e.id,
        ...
        (l = {
                                ...
                                : req.get
                                    ...
                                    : (
                                        ...
                                        hasProp(m, r)
                                            ...
                                            : O(makeError(
                                                "notloaded",
                                                'Module name "' + r + '" has not been loaded yet for context: ' + u + (
                                                    o
                                                        ? ""
                                                        : ". Use require([])"
                                                )
            ...
            onScriptError: function (e) {
                ...
                if (!w(i.id)) {
                    ...
                    O(makeError("scripterror", 'Script error for "' + i.id + (
                        r.length
                            ? '", needed by: ' + r.join(", ")
                            : '"'
                    ), e, [i.id]))
    ...
    function getInteractiveScript() {
        return interactiveScript && "interactive" === interactiveScript.readyState || eachReverse(
            scripts(),
            function (e) {
